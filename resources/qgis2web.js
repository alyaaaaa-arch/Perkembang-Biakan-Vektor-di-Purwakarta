...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [107.415168, -6.533760, 107.473944, -6.494657], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([107.415168, -6.533760, 107.473944, -6.494657], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Adm_DesaMulyamekardanCiwarenggadm41_idn_4_1,
    colName: 'NAME_4',
    zoom: 10,
    collapsed: true,
    map: map
